...
function pug_rethrow(n, e, r, t) { if (!(n instanceof Error)) throw n; if (!("undefined" == typeof window && e || t)) throw n.message += " on line " + r, n; try { t = t || require("fs").readFileSync(e, "utf8") } catch (e) { pug_rethrow(n, null, r) } var i = 3, a = t.split("\n"), o = Math.max(r - i, 0), h = Math.min(a.length, r + i), i = a.slice(o, h).map(function (n, e) { var t = e + o + 1; return (t == r ? "  > " : "    ") + t + "| " + n }).join("\n"); throw n.path = e, n.message = (e || "Pug") + ":" + r + "\n" + i + "\n\n" + n.message, n } function template(locals) {
  var pug_html = "", pug_mixins = {}, pug_interp; var pug_debug_filename, pug_debug_line; try {
        ...
        ; (function () {
          ...
          if ('number' == typeof $$obj.length) {
            for (var pug_index2 = 0, $$l = $$obj.length; pug_index2 < $$l; pug_index2++) {
              ...
              pug_html = pug_html + " - ";
              ; pug_debug_line = 31; pug_debug_filename = "pug\u002Fbackground\u002Fwork-experience.pug";
              pug_html = pug_html + (pug_escape(null == (pug_interp = experience.endDate || '現在') ? "" : pug_interp)) + "\u003C\u002Fspan\u003E";
        ...
        ; (function () {
          ...
          if ('number' == typeof $$obj.length) {
            for (var pug_index5 = 0, $$l = $$obj.length; pug_index5 < $$l; pug_index5++) {
              ...
              pug_html = pug_html + " - ";
              ; pug_debug_line = 33; pug_debug_filename = "pug\u002Fbackground\u002Fprojects-experience.pug";
              pug_html = pug_html + (pug_escape(null == (pug_interp = project.endDate || '現在') ? "" : pug_interp)) + "\u003C\u002Fspan\u003E";
        ...
        ; (function () {
          ...
          if ('number' == typeof $$obj.length) {
            for (var pug_index11 = 0, $$l = $$obj.length; pug_index11 < $$l; pug_index11++) {
              ...
              pug_html = pug_html + " - ";
              ; pug_debug_line = 29; pug_debug_filename = "pug\u002Fbackground\u002Feducation.pug";
              pug_html = pug_html + (pug_escape(null == (pug_interp = education_info.endDate || '現在') ? "" : pug_interp)) + "\u003C\u002Fsmall\u003E\u003C\u002Fp\u003E";
        ...
        ; (function () {
          ...
          if ('number' == typeof $$obj.length) {
            for (var pug_index16 = 0, $$l = $$obj.length; pug_index16 < $$l; pug_index16++) {
              ...
              pug_html = pug_html + " - ";
              ; pug_debug_line = 31; pug_debug_filename = "pug\u002Fbackground\u002Fvolunteer-work.pug";
              pug_html = pug_html + (pug_escape(null == (pug_interp = volunteer_info.endDate || '現在') ? "" : pug_interp)) + "\u003C\u002Fsmall\u003E\u003C\u002Fp\u003E";
    ...
    }.call(this, "_" in locals_for_with ? locals_for_with._ : typeof _ !== "undefined" ? _ : undefined, "css" in locals_for_with ? locals_for_with.css : typeof css !== "undefined" ? css : undefined, "floating_nav_items" in locals_for_with ? locals_for_with.floating_nav_items : typeof floating_nav_items !== "undefined" ? floating_nav_items : undefined, "resume" in locals_for_with ? locals_for_with.resume : typeof resume !== "undefined" ? resume : undefined));
